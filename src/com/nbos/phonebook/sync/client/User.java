...
public class User {
    ...
    private int mUserId, mContactId;
  ...
  /*  public User(String name, String firstName, String lastName,
    ...
    public User(String name, String number, Integer userId) {
            mUserName = name;
            mFirstName = name;
            mCellPhone = number;
            mContactId = 0;
    ...
    public User(String name, String number, Integer userId, Integer contactId) {
        mUserName = name;
        mFirstName = name;
        mCellPhone = number;
        mDeleted = false;
    ...
    public static User valueOf(JSONObject user) {
        try {
            ...
            return new User(firstName, cellPhone, userId);
